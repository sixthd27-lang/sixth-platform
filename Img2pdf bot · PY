...
WELCOME_MSG = """
🌟 <b>أهلاً بك في أفضل بوت تحويل صور إلى PDF!</b>

📸➡️📄 أرسل لي صورك وسأحولها لملف PDF احترافي فوراً!

<b>✨ المميزات:</b>
• دعم صور متعددة في ملف واحد (حتى 50 صورة)
• اختيار حجم الصفحة (A4, Letter, Legal, حجم أصلي)
• اختيار الاتجاه (عمودي / أفقي)
• اختيار جودة الصورة
• إعادة ترتيب الصور قبل التحويل
• حذف صور محددة من القائمة
• معاينة عدد الصور المضافة

<b>📌 طريقة الاستخدام:</b>
1. أرسل الصور (واحدة أو أكثر)
2. اختر الإعدادات المناسبة
3. اضغط <b>تحويل إلى PDF</b> 🚀
